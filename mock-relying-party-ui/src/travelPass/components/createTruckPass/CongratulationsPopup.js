    ...
    return (
        <div className='bg-white h-full border border-[#E4E7EC] rounded-lg shadow-sm'>
            <div className='flex flex-col h-[22rem] py-[1rem] items-center justify-center space-y-3 text-center'>
                ...
                <p className='text-sm lg:text-lg font-semibold text-[#42307D]'>Your driver's travel pass is now ready for download</p>
                <p className='text-xs lg:text-sm font-[500] text-[#42307D] w-[25rem]'>Please ask your driver/traveler to download the travel pass and keep it accessible for smooth border crossing.</p>
