...
function UploadEinvoicePage({ userInfo, setInVoiceDetails, goBack, setShowPrevDetails, setRevert }) {
    ...
    <div className='bg-white h-[30rem] border border-[#E4E7EC] rounded-lg shadow-sm'>
      <div className='flex items-center justify-between h-[8rem] lg:px-[3rem] lg:py-[0.6rem] lg:my-2 px-[2rem] py-[0.8rem] '>
        <div className='flex-col'>
          <h1 className='text-[#2C3345] font-semibold text-lg lg:text-[1.85rem]'>Fill Your Driver Details</h1>
        </div>
        ...
        {!showUploadingBlock && (
          <div className='flex items-center lg:px-[1rem] px-[1.5rem] rounded-md bg-[#FEFAEA] lg:h-[7.2rem] lg:w-[24rem] h-[6.3rem] w-[20rem]'>
            <div className='flex-col gap-y-3'>
              ...
              <p className='text-xs'>For a smooth truck pass generation experience, we've provided a sample invoice for your reference. You can download it and proceed with updating the driver’s details. </p>
              <p onClick={downloadInvoice}
      ...
      <div className='flex justify-between lg:px-[2rem] md:px-[0.3rem] py-[0.9rem]'>
        {userInfo && (
          <form className='flex flex-wrap w-[40rem] justify-around gap-y-3'>
            <label className='mx-1 lg:h-[4.15rem] lg:w-[18.5rem] md:h-[2rem] md:w-[9rem]'>
