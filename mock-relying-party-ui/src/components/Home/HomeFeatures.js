...
export const HomeFeatures = ({ i18nKeyPrefix = "login" }) => {
  ...
  return (
    <div className="mt-16 h-full bg-[url('./assets/bg.svg')] bg-repeat">
      <div className="mx-[4.5em]">
        <div className="flex">
          <div className="mb-8 mt-28 w-2xl w-1/2">
            ...
            <div className="flex flex-wrap gap-4 py-12 pr-12">
              <div className="bg-white border border-[#E0E4E5] rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
                Register your Child's Birth
              </div>
              <div className="bg-white border border-gray-300 rounded-md py-2 px-4  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
        ...
        <div className="bg-white rounded-lg border border-[#E0E4E5] flex shadow-md">
          <div className="bg-white py-12 pl-6 pr-0 flex flex-col justify-center w-[40%] rounded-lg">
            <div className="border-r-gray-200 border-r pr-14">
              <p className="text-[#282828] mb-4 font-normal text-center text-sm">
                Conveniently view and track all your government services
                effortlessly. Login to view all your entitled benefits.
              </p>
              {state === "ready" && (
                <button
                  className="bg-[#2868E8] hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  onClick={() =>
                    document
                      .getElementById("sign-in-with-esignet")
                      .children[0].click()
                  }
                >
              ...
              {state === "ready" && (
                <button id="sign-in-with-esignet" className="hidden"></button>
              )}
              <div className="mt-2 text-gray-500 text-xs flex justify-center">
                ...
                <span>&nbsp;&nbsp;Securely login using eSignet</span>
              </div>
            </div>
          </div>
          <div className="flex items-start m-auto px-4 py-6">
            ...
            <div className="mx-2">
              ...
              <p className="text-gray-500 text-sm font-light">
                Find services and benefits in one place
              </p>
            </div>
          </div>
          <div className="flex items-start m-auto px-4 py-6">
          ...
          <div className="flex items-start m-auto px-4 py-6">
            ...
            <div className="mx-2">
              ...
              <p className="text-gray-500 text-sm font-light">
                Safe access, tailored to your needs
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white pt-12 pb-6">
        <div className="mx-[4.5em] flex justify-between">
          ...
          <div className="flex flex-col">
            <a href="#" className="text-gray-700 hover:text-gray-900 mb-4">
              Home
            </a>
            <a href="#" className="text-gray-700 hover:text-gray-900 mb-4">
              Services
