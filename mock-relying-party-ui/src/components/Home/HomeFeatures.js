    ...
    return (
        <div className="my-28 h-full bg-[url('./assets/bg.svg')] bg-repeat">
            <div className="mx-32 px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-l-xl border flex shadow-md">
                    <div className="bg-white p-6 flex flex-col justify-center border-r-gray-200 border-r-2 w-[40%]">
                        <p className="text-gray-700 mb-4 font-light text-center text-lg">
                    ...
                    <div className="flex items-start m-auto p-16">
                        ...
                        <div className="ml-3">
                            <h3 className="text-xl font-light text-gray-600">All-in-One Access</h3>
                            <p className="text-gray-500 text-lg font-extralight">Find services and benefits in one place</p>
                        </div>
                    </div>
                    <div className="flex items-start m-auto p-16">
                        <div className="flex-shrink-0">
                        ...
                        <div className="ml-3">
                            <h3 className="text-xl font-light text-gray-600">Quick & Easy</h3>
                            <p className="text-gray-500 text-lg font-extralight">Do more in less time, anytime</p>
                        </div>
                    </div>
                    <div className="flex items-start m-auto p-16">
                        <div className="flex-shrink-0">
                        ...
                        <div>
                            <h3 className="text-xl font-light text-gray-600">Secure & Personalised</h3>
                            <p className="text-gray-500 text-lg font-extralight">Safe access, tailored to your needs</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="mx-auto px-4 flex justify-evenly">
                    ...
                    <div className="flex ">
                        <div className="flex flex-col items-start">
                            ...
                            <a href="#" className="bg-gray-900 hover:bg-gray-800 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-1 mb-2 flex items-center">
                                Download for iOS
                            </a>
                            <a href="#" className="bg-gray-900 hover:bg-gray-800 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-1 flex items-center">
