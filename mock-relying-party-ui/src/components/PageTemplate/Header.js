  ...
  return (
    <header>
      ...
      >
        ...
        {props.showLogout && (
          <div className="min-h-fit min-w-fit self-center">
            <button
              className="bg-[#F3F8FE] text-[#2868E8] font-semibold pl-4 pr-5 py-2 mr-[4.75em] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center border-[2px] border-[#D3E7FE]"
              onClick={() => navigate("/")}
            >
              <svg
                className="mx-1"
