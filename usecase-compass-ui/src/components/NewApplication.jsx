...
const NewApplication = () => {
    ...
    return (
        <div className={`${showSuccessMsg ? "flex items-center justify-center bg-[length:100%_100%]" : "bg-[length:100%_50%]"} bg-[url('public/assets/background.png')] bg-no-repeat w-[100%] py-8 px-12 flex justify-center`}>
