...
const scopeUserProfile = checkEmptyNullValue(
  window._env_.SCOPE_USER_PROFILE_FOREIGNER,
  "openid profile"
);
const scopeRegistration = checkEmptyNullValue(
  window._env_.SCOPE_REGISTRATION_FOREIGNER,
  "openid profile"
);
const display = checkEmptyNullValue(window._env_.DISPLAY_FOREIGNER, "page");
const prompt = checkEmptyNullValue(window._env_.PROMPT_FOREIGNER, "consent");
const grantType = checkEmptyNullValue(
  window._env_.GRANT_TYPE_FOREIGNER,
  "authorization_code"
);
const maxAge = window._env_.MAX_AGE_FOREIGNER;
const claimsLocales = checkEmptyNullValue(window._env_.CLAIMS_LOCALES_FOREIGNER, "en");
const authorizeEndpoint = "/authorize";
const clientId = window._env_.CLIENT_ID_FOREIGNER;
const uibaseUrl = window._env_.ESIGNET_UI_BASE_URL_FOREIGNER;
const redirect_uri_userprofile = checkEmptyNullValue(
  window._env_.REDIRECT_URI_USER_PROFILE_FOREIGNER,
  window._env_.REDIRECT_URI_FOREIGNER
);
const redirect_uri_registration = checkEmptyNullValue(
  window._env_.REDIRECT_URI_REGISTRATION_FOREIGNER,
  window._env_.REDIRECT_URI_FOREIGNER
);
const acr_values = window._env_.ACRS_FOREIGNER;
const userProfileClaims = checkEmptyNullValue(
  window._env_.CLAIMS_USER_PROFILE_FOREIGNER,
  "{}"
);
const registrationClaims = checkEmptyNullValue(
  window._env_.CLAIMS_REGISTRATION_FOREIGNER,
  "{}"
);
...
export default clientDetailsForeigner;
