...
public class AuthenticationServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        jsonNode = objectMapper.readTree(jsonIdentity);
    }
    ...
    public void kycAuth2_withValidKbiChallenge_thenPass() throws Exception {
        ...
        int oidcSupportedIdentityData =getOidcSupportedIdentityData(jsonNode,oidcClaimsMap);
        Map<String,List<VerificationDetail>> claimMetaData = kycAuthResponseDtoV2.getClaimMetaData();
