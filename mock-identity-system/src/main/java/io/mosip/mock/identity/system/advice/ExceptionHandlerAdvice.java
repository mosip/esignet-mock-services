package io.mosip.mock.identity.system.advice;

import static io.mosip.mock.identity.system.util.ErrorConstants.INVALID_REQUEST;
import static io.mosip.mock.identity.system.util.ErrorConstants.UNKNOWN_ERROR;
...
import io.mosip.mock.identity.system.dto.Error;
...
public class ExceptionHandlerAdvice extends ResponseEntityExceptionHandler {
    ...
    private ResponseWrapper getResponseWrapper(List<Error> errors) {
		...
		responseWrapper.setResponseTime(MockIdentityUtil.getUTCDateTime());
